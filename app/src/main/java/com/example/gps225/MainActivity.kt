        ...
        when(requestCode){
            REQUEST_CODE->{
                if (grantResults.size>0)
                {
                    ...
                    else Toast.makeText(this@MainActivity, "Permition Denied", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
        ...
        else
        {
            ...
            btn_start_update.setOnClickListener(View.OnClickListener {
                if (
                    ...
                    != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this@MainActivity,android.Manifest.permission.ACCESS_COARSE_LOCATION)
    ...
    private fun buildLocationCallBack() {
        locationCallback=object : LocationCallback(){
            override fun onLocationResult(p0: LocationResult?){
                ...
                txt_location.text=location.latitude.toString()+"/"+location.longitude.toSting()
            }
        }
